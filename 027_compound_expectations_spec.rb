RSpec.describe 25 do
    it 'can test for multiple matcher' do
        ...
        # Combined the above statements into 1
        expect(subject).to be_odd.and be < 100

    end

    it { is_expected.to be_odd and be < 100  }
end


RSpec.describe 'catepillar' do
    it 'supports multiple matcher in a single line' do
